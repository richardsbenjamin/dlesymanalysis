...
# Output paths
OUTPUT_FILE="${OUTPUT_DIR}/basic_stats.out" # Path to catch errors and logs
OCEAN_PATH="${GBUCKET}/ocean_stats.zarr"
ATMOS_PATH="${GBUCKET}/atmos_stats.zarr"
...
RUN_CMD="python scripts/calc_basic_stats.py \
