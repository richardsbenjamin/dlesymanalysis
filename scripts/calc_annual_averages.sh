...
# Output paths
OUTPUT_FILE="${OUTPUT_DIR}/calc_annual_averages.out" # Path to catch errors and logs
OCEAN_PATH="${GBUCKET}/ocean_global_averages.zarr"
ATMOS_PATH="${GBUCKET}/atmos_global_averages.zarr"
...
RUN_CMD="python scripts/calc_annual_averages.py \
